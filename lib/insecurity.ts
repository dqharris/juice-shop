...
const privateKey = process.env.JWT_PRIVATE_KEY
  ...
  : (fs ? fs.readFileSync('encryptionkeys/jwt.pem', 'utf8') : 'placeholder-private-key')
...
const hmacSecret = process.env.HMAC_SECRET || 'pa4qacea4VK9t9nGv7yZtwmj'
...
export const isRedirectAllowed = (url: string) => {
  ...
  for (const allowedUrl of redirectAllowlist) {
    allowed = allowed || url.indexOf(allowedUrl) === 0 // vuln-code-snippet vuln-line redirectChallenge
  }
  return allowed
}
